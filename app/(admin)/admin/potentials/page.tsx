...
const EMPTY_FORM: PotentialFormData = {
  studentId: "",
  fullName: "",
  career: "",
  position: "",
...
export default function PotentialsAdminPage() {
  ...
  const [form, setForm] = useState<PotentialFormData>(EMPTY_FORM);
          ...
          <div className="w-full max-w-lg rounded-2xl bg-white shadow-xl max-h-[90vh] flex flex-col">
            ...
            >
              <h2 className="text-lg font-semibold">
                {modalMode === "create" ? "เพิ่มข้อมูลศักยภาพ" : "แก้ไขข้อมูลศักยภาพ"}
              </h2>
              <button
                onClick={closeModal}
            ...
            <div className="flex-1 overflow-y-auto px-6 py-5 space-y-4">
              ...
              <Field label="อาชีพ *" error={formErrors.career}>
                <input
                  type="text"
                  value={form.career}
                  onChange={(e) => setForm((f) => ({ ...f, career: e.target.value }))}
                  className={inputClass(formErrors.career)}
                />
              </Field>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
          <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl">
            ...
            <p className="mb-6 text-sm text-gray-600">
              คุณต้องการลบข้อมูลศักยภาพนี้หรือไม่? การดำเนินการนี้ไม่สามารถย้อนกลับได้
            </p>

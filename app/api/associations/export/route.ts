...
function buildResponse(rows: Record<string, unknown>[], filename: string) {
  ...
  XLSX.utils.book_append_sheet(workbook, worksheet, "สมาคม/ชมรม");
...
export async function GET(request: NextRequest) {
  try {
    ...
    const validSortFields = ["createdAt", "studentId", "fullName", "associationName", "position", "recordedYear"];
    ...
    return buildResponse(rows, "associations_export");
  } catch (error) {

...
export async function PUT(
  ...
  try {
    ...
    if (session) {
      ...
      await recordFieldChanges({ resourceType: "association", resourceId: id, changes, actor: { actorType: "ADMIN", userId: session.user.id, actorName: session.user.email }, reason: validated.reason, activityLogId: logId });
    }
